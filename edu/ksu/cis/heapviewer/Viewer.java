...
public class Viewer extends Panel {
	  ...
	  private JComboBox<String> choices 
		...
		"Leftist Heap", "Randomized Heap", "Skew Heap"});
	...
	public static void main(String[] args) {
	  ...
	  public void openWindow() {
	    ...
	    case 0:
			new HeapFrame(new BinaryHeap(),
				      "Binary Heap").setVisible(true);
			break;
        case 1:
			new HeapFrame(new BinomialQueue(),
				      "Binomial Queue").setVisible(true);
	    	break;
		case 2:
			new HeapFrame(new LeftistHeap(),
				      "Leftist Heap").setVisible(true);
			break;
		case 3:
        	new HeapFrame(new RandomizedHeap(),
			      "Randomized Heap").setVisible(true);
        	break;
		case 4:
	    	new HeapFrame(new SkewHeap(),
			      "Skew Heap").setVisible(true);
	    }
	  }
	/**
