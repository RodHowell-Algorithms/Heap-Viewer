...
import edu.ksu.cis.viewer.GenericStack;
...
public class HeapFrame extends JFrame {
	   ...
	   */
	  private GenericStack<PriorityQueue> history;

	  /**
	   * The queues accessible via the "Forward" button.
	   */
	  private GenericStack<PriorityQueue> future;
	  ...
	  public HeapFrame(PriorityQueue t, String title) {
	    this(t, title, lastSize, lastStyle,
		 new GenericStack<PriorityQueue>(),
		 new GenericStack<PriorityQueue>());
	  }
	  ...
	  public HeapFrame(PriorityQueue t, String title, int size, int style) {
	    this(t, title, size, style, new GenericStack<PriorityQueue>(),
		 new GenericStack<PriorityQueue>());
	  }
	  ...
	  private HeapFrame(PriorityQueue t, String title,
			    ...
			    GenericStack<PriorityQueue> history,
			    GenericStack<PriorityQueue> future) {
	    if (fontSize < 1) 
	  ...
	  public synchronized void put() {
	  	...
	  	try {
		    ...
		    if (!future.empty()) {
		      future = new GenericStack<PriorityQueue>();
		    }
